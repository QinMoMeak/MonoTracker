          ...
          {availableFilters.map(filterValue => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-1.5 whitespace-nowrap rounded-full px-4 py-1.5 text-xs font-bold transition-all ${activeFilter === filterValue ? `${themeColors.primary} text-white shadow-md` : 'bg-gray-100 text-gray-500 dark:bg-slate-800 dark:text-gray-400'}`}
              >
